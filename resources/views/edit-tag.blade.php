...
<div class="container-fluid">
    ...
    <div class="col col-10 m-5">
        <form method="post" action="{{ route('panel-updateTag' , $tag->id) }}" enctype="multipart/form-data" >
            @csrf
            <div class="mb-3">
                <label for="recipient-name " class="col-form-label">کاور پست</label>
                <input name="cover" class="form-control" type="file" id="formFile" value="{{ $tag->cover }}">
            </div>
            @error('cover')
            {{ $message }}
            @enderror
            ...
            <div class="mb-3">
                ...
                <input name="label_fa" type="text" class="form-control" id="recipient-name"  value="{{ $tag->label_fa }}">
            </div>
            @error('label_fa')
            {{ $message }}
            @enderror
            ...
            <div class="mb-3">
                ...
                <input name="label_en" type="text" class="form-control" id="recipient-name" value="{{ $tag->label_en }}">
            </div>
            @error('label_en')
            {{ $message }}
            @enderror
            ...
            <div class="mb-3">
                ...
                <input name="slug" type="text" class="form-control" id="recipient-name" value="{{ $tag->slug }}">
            </div>
            @error('slug')
            {{ $message }}
            @enderror
            ...
            <div class="mb-3">
                ...
                <input name="caption_fa" type="text" class="form-control" id="recipient-name" value="{{ $tag->caption_fa }}">
            </div>
            @error('caption_fa')
            {{ $message }}
            @enderror
            <div class="mb-3">
                ...
                <input name="caption_en" type="text" class="form-control" id="recipient-name" value="{{ $tag->caption_en }}">
            </div>
            @error('caption_en')
            {{ $message }}
            @enderror
