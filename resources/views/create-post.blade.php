...
<div class="container-fluid">
    ...
    <div class="col col-10 m-5">
        <form method="post" action="{{ route('panel-saveNewPost') }}" enctype="multipart/form-data" >
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input name="title_fa" type="text" class="form-control" id="recipient-name">
            </div>
            @error('title_fa')
            {{ $message }}
            @enderror
            <div class="mb-3">
                ...
                <input name="title_en" type="text" class="form-control" id="recipient-name">
            </div>
            @error('title_en')
            {{ $message }}
            @enderror
            ...
            <div class="mb-3">
                ...
                <input name="description_fa" type="text" class="form-control" id="recipient-name">
            </div>
            ...
            <div class="mb-3">
                ...
                <input name="description_en" type="text" class="form-control" id="recipient-name">
            </div>
            ...
            <div class="mb-3">
                ...
                <input name="keywords_fa" type="text" class="form-control" id="recipient-name">
            </div>
            @error('keywords_fa')
            {{ $message }}
            @enderror
            ...
            <div class="mb-3">
                ...
                <input name="keywords_en" type="text" class="form-control" id="recipient-name">
            </div>
            @error('keywords_en')
            {{ $message }}
            @enderror
            ...
            <div class="mb-3">
                ...
                <textarea name="body_fa" id="content_fa" class="text-dark"></textarea>
            </div>
            @error('body_fa')
            {{ $message }}
            @enderror
            ...
            <div class="mb-3">
                ...
                <textarea name="body_en" id="content_en" class="text-dark"></textarea>
            </div>
            @error('body_en')
            {{ $message }}
            @enderror
            ...
            <div class="mb-3 col-12">
                ...
                @if(!$tags->isEmpty())
                    <select class="js-example-basic-multiple col col-12" name="tags[]" multiple="multiple">
                        @foreach($tags as $tag)
                            <option value="{{ $tag->id }}" >{{ $tag->label_fa }}</option>
                        @endforeach
                    </select>
                @else
